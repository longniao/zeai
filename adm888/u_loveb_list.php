...
$rt = $db->query("SELECT content,num,endnum,addtime FROM ".__TBL_LOVEB_LIST__." WHERE ".$SQL.$ORDER);
...
if ($total <= 0 ) {
	...
	$sorthref = SELF."?uid=".$uid."&tg_uid=".$tg_uid."&parameter=".$parameter."&sort=";
?>
...
<table class="tablelist W95_ Mtop10" style="margin-bottom:0px">
<tr>
<th width="140">结算时间
<div class="sort">

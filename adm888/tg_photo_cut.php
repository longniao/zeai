...
if ($ifm == 1){
	$uid = $id;
	if (empty($tmpphoto)){
		$row = $db->ROW(__TBL_TG_USER__,'photo_s',"id=".$uid);
...
<div class="pbox">
	...
	<form action="<?php echo $_ZEAI['up2']; ?>/tucotohpiaez_tg_photo_s_adm.php" name="myform" method="post">
    ...
    <input type="hidden" name="uu" value="<?php echo $session_uid; ?>">
    <input type="hidden" name="pp" value="<?php echo $session_pwd; ?>">
	</form>
</div>
<div class="clear"></div>

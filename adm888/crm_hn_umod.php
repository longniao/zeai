...
if ($submitok == 'sendupdate'){
	if ( !ifint($hnid) )textmsg('请选择要调换的红娘','back','返回');
...
<script>
function chkform(){
	parent.zeai.confirm('确定要调换么？',function(){zeai.msg('正在调换中...',{time:100});www_zeai_cn_FORM.submit();})
}
</script>
<form id="www_zeai_cn_FORM" method="post" action="<?php echo SELF; ?>">
<table class="table0">
<tr>
<td class="tdL">调换会员UID</td>
...
<tr>
  <td height="60" colspan="2" class="center"><input type="button" value="　开始调换　" class="btn size3 HONG2" onclick="chkform()"></td>
</tr>
</table>

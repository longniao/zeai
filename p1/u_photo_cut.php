<?php
/******************************************
Copyright(C)2019 www.zeai.cn V6.0
...
<link href="css/u_photo_cut.css" rel="stylesheet" type="text/css">
<style>
...
<div class="cutbtn">
<h3>
    <a href="javascript:change_size(1);" class="cutbt1"></a>
    <a href="javascript:change_size(-1);" class="cutbt2"></a>
    <a href="javascript:turn(1);" class="cutbt3"></a>
    <a href="javascript:turn(-1);" class="cutbt4"></a>
    <div class="clear"></div>
</h3>
<a href="javascript:supdessubmit();" class="cutbt5 tipss" tips-title="将照片需要的部分拖到红色框内，以裁切出满意的头像" tips-direction='bottom'>裁切并保存头像</a>
</div>
<div class="pbox">
    <div class="canvas">
    ...
    <script src="js/u_photo_cut.js"></script>
    <script>document.onmousemove=move_it;document.onmouseup=free;</script>
	<form action="<?php echo $_ZEAI['up2']; ?>/tucotohp_nc_iaez_photo_s_u.php" name="myform" method="post">
	...
	<input type="hidden" name="return_url" value="http://www.esyyw.com" >
	<input type="hidden" name="j" value="GYL_supdes__www.esyyw_com">
    <input type="hidden" name="uid" value="<?php echo $uid; ?>">
    <input type="hidden" name="ifm" value="<?php echo $ifm; ?>">
    <input type="hidden" name="uid" value="<?php echo $cook_uid; ?>">
    <input type="hidden" name="pwd" value="<?php echo $cook_pwd; ?>">
	</form>
</div>
<div class="clear"></div>
